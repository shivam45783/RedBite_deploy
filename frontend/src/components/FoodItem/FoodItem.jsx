...
const FoodItem = ({ id, name, price, description, image }) => {
  ...
  return (
    <div
      className="food-item w-full m-auto rounded-[15px] shadow-[0_2px_10px_rgba(0,0,0,0.15)] hover:shadow-[0_6px_16px_rgba(0,0,0,0.2)] duration-300 hover:-translate-y-1 hover:scale-[1.05]"
      id={`${id}`}
    >
